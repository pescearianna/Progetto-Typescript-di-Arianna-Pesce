interface IProduct {
    productType: 'beachwear' | 'sarong' | 'hat';
    id: number;
    size: string;
    colour: string;
    available: boolean;
    assignToClient(client: IClient): void;
}
...
class Client implements IClient{
    ...
    constructor( name: string, lastname: string, email: string, paymethod: string){
        this.name = name;
    ...
    orderProduct(product: IProduct): string {
...
class Product implements IProduct{
    ...
    constructor(productType:'beachwear' | 'sarong' | 'hat', id:number ,size:string,colour: string,available:boolean){
    ...
    assignToClient(client: IClient): string{
...
class ProductionProcess implements IProductionProcess {
    ...
    constructor(name:string, description:string, currently_prod:IProduct[]){
        this.name = name;
